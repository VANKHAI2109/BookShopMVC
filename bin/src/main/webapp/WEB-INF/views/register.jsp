...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" required="true" placeholder="Mật khẩu" name="password">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Nhập lại mật khẩu</label>
    <input type="text" class="form-control" required="true" placeholder="Nhập lại mật khẩu" name="password2">
  </div>
